...
<?php 
	if(isset($_POST["submit"]))
	{
		...
		else
		{
			...
			if(!empty($Image))
			{
				$sql ="UPDATE posts SET title='$PostTitle',category='$Category',post='$Posttext',image='$Image' WHERE id='$sqp'";
			}
			else
			{
				$sql ="UPDATE posts SET title='$PostTitle',category='$Category',post='$Posttext' WHERE id='$sqp'"; 
			}
...
<header class=" py-3" >
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 style="color: orange"> <i class="far fa-edit"></i><b> Edit Post</b></h2>
			</div>
		</div>
	</div>
				...
				<div class="card bg-dark text-white">
					...
					<div class="card-body ">
						<div class="form-group">
							...
							<input class="form-control" type="text" name="ctgtitle" id="Posttitle" placeholder="TYPE YOUR POST HERE" value="<?php echo $updatetitle;?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="Postarea" name="Postdesc" rows="10">
								<?php echo $updatepost; ?>
							</textarea>
						</div>
						<div class="form-group">
